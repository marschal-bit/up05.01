...
import androidx.appcompat.app.AppCompatActivity;  // ДЕНЬ 12 ШАГ 2: импорт AppCompatActivity
...
// ДЕНЬ 12 ШАГ 2: Изменен суперкласс с FragmentActivity на AppCompatActivity
public class BookPagerActivity extends AppCompatActivity {
    private static final String EXTRA_BOOK_ID = "ru.ваша_фамилия.bookdepository.book_id";
